...
//     const distance = map.distance(prevLocation, currentLocation);
...
//           // Update route automatically
//           if (coordinates) {
//             updateRoute(newUserLocation, coordinates);
//           }

//           const mapCenter = map.getCenter();
//           const distance = map.distance([latitude, longitude], [mapCenter.lat, mapCenter.lng]);
//           if (distance > 50) {
//             map.panTo(newUserLocation, { animate: true, duration: 1 });
//           }
//         },
//         (error) => {
...
//     refreshIntervalRef.current = setInterval(updateLocation, 2000);
